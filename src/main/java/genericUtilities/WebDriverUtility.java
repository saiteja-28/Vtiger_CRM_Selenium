...
public class WebDriverUtility {
	...
	public String getScreenshot(WebDriver driver, JavaUtility jutil, String classname) {
		...
		File target = new File("./Screenshots/" + classname + " " + jutil.getCurrentTime() + ".png");
		try {
	...
	public void scrollToElement(WebElement element) {
		...
		js.executeScript("argument[o]", "scrollIntoView()", element);
	}
	...
	public WebElement convertDynamicXpathTowebElement(String commonxpath, String replaceData) {
		String requiredpath = String.format(commonxpath, replaceData);
